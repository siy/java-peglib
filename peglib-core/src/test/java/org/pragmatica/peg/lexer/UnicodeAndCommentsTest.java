...
class UnicodeAndCommentsTest {
    ...
    private static org.pragmatica.peg.Parser java25Parser() throws Exception {
        var grammar = Files.readString(Path.of("src/test/resources/java25.peg"));
        return PegParser.fromGrammar(grammar).unwrap();
    }

    private static void assertClean(org.pragmatica.peg.Parser parser, String input) {
    ...
    void dfa_nonAsciiTransition_positiveClassRejectsBmpPlus() {
        ...
        .isEqualTo(org.pragmatica.peg.token.TokenArray.KIND_WHITESPACE);
    }
