...
class SpliceSubtreeTest {
     ...
     * splice will see (its {@link org.pragmatica.peg.token.TokenArray#input() input}
     * matches the post-splice text). */
    private static org.pragmatica.peg.token.TokenArray buildPostSpliceTokens(int oldFirst,
                                                                                int oldLast,
                                                                                int newTokenCount) {
